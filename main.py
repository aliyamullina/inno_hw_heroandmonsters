...
def game():
    ...
    if answer in '1':
        ...
        while hero_hp >= 0 or hero_attack >= 0:
            ...
            hero_hp = monsters(hero_hp, hero_attack)
    else:
...
def monsters(x, y):
    ...
    print('БОЙ! На горизонте чудовище с ', monster_hp, ' жизнями и с силой атаки ', monster_attack)
    print('У тебя жизнь:', x, ' и сила атаки:', y)
    ...
    if answer in '1':
        ...
        if y > monster_hp and monster_attack < x:
            ...
            print('ПОБЕДА! Но твоя жизнь сократилась до', x)
            return x
        else:
