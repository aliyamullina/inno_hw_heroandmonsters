...
def game():
    ...
    if answer in '1':
        ...
        win_count = 10
        print('Ты — рыцарь в фантастической стране. Задача — победить', win_count, 'чудовищ, '
        ...
        while m_counter < win_count:
            ...
            hero_hp, m_counter = monsters(hero_hp, hero_attack, m_counter)
...
def monsters(x, y, z):
    ...
    if answer in '1':
        ...
        if y >= monster_hp and monster_attack <= x:
            x = x - monster_attack
            z = z + 1
            print('В бою твоя жизнь сократилась до', x)
            return x, z
        else:
            return x, z
